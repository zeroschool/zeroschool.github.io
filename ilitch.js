...
<body style="background-color:#212529;">
    <h4 style="text-align: center;">ZeroSchool - Ceci n'est pas une école.</h4>
    <div class="nes-container is-dark with-title">
        <form onsubmit="return false">
            <textarea type="text" id="post" class="nes-input is-dark" placeholder="What do you *really* wanna learn?"></textarea>
    ...
    <span id="wait" style=color:#fff>Deschooling Society</span>
...
<script>
    ...
    function firstTime() {
        ...
        /*if (itoken === null) {
            showPopup(`<p class="title" style="color: #21e800; font-family: fixedsys_excelsior_3.01Rg;">a6fe7f87c61982cd5eac329ed50564d34b579b888e346cc53e4347a0bfcedf45</p><p style="font-family: fixedsys_excelsior_3.01Rg">Tokenize your Twetches (if logged in with MB) using state-of-the-art 21e8 & fren-2-fren technologies, or don't, whatever.<br><br>
                Posts, likes, tipping, & Boost are currently supported along with Bitcoinfiles & Relay OTC integration.<br><br>
                Mine Twetch Arcade transactions with <a href="https://github.com/deanmlittle/21e8miner" target="_blank" text-decoration="none">21e8 miner</a> and earn bitcoin.<br><br>
                Magic numbers can be found at <a href="http://sha.center" target="_blank" text-decoration="none">sha.center</a> with your txid.<br><br>
                Boost jobs are tokenized too.<br><br>
    ...
    async function buildIMB(content, action) {
        ...
        outputs = [{
            ...
            to: "272a00x7709e0a4fbb9ccf35b94d0c9023d3322c6365591f7f485ced2cfb54e7c4113e5@21e8.dev",
            amount: "0.00001000",
            currency: "BSV"
        }].concat(payees);
    ...
    async function send(action, likeTx, tipped) {
        ...
        imb.swipe({
            ...
            onPayment: async(payment) => {
                if (tipped === true) {
                    coinSound.play();
                    loadingText = 'Hashing your content...'
                }
                ...
                if (action === 'twetch/post@0.0.1') {
                    loadingPost = false;
                    loadingText = 'collision detected...';
                    location.reload()
                }
            },
    ...
    async function getBoosts() {
        let res = await axios.get('https://graph.boostpow.com/api/v1/main/boost/search?tag=$21e8');
    ...
    async function postsQuery() {
        ...
        for (let i = 0; i < posts.length; i++) {
            let content = posts[i].bContent.replace('$zeroschool', '');
    ...
    function boost() {
        boostPublish.open({
            ...
            tag: '$21e8',
            outputs: [{
                to: "1ARCADEENa9tip8yFDT2mN4uvxwxPYRfak",
                amount: "0.00001000",
                currency: "BSV"
            }, {
                to: "272a00x0d791a0a6f01100118b48ef924ee40b6911da8348f0e7bad36cf70b4df1c4a64@21e8.dev",
                amount: "0.00002145",
                currency: "BSV"
            }],
